		...
		<view class="ads-list">
			...
			<view class="ads-box">
				<view class="ads-main">
					...
					<view class="ads-text">
						在平台APP启动的时候（仅限原生安卓和苹果），平台将随机显示一条启动图广告。您发布的广告将以启动大图的形式显示在所有用户的启动界面，且每一次用户打开APP都可能获得推送，由于启动图广告名额较少，您将可以较快的获得曝光。<text class="text-red">为了展现效果，需上传像素宽度1080，长度2340的图片。</text>
					</view>
					<view class="ads-info grid col-3 text-center">
						<view class="ads-num">
